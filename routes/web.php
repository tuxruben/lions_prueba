...
Route::get('liberacionAutomatica', 'salas_juntasController@liberacionAutomatica');
Route::post('salas_juntas', 'salas_juntasController@store');
Route::put('salas_juntas/{salas_junta}', 'salas_juntasController@update');
Route::put('reservacion/{salas_junta}', 'salas_juntasController@Reservacion');
Route::put('liberacion/{salas_junta}', 'salas_juntasController@Liberacion');
